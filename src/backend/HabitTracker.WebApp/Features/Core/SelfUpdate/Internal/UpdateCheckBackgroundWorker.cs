...
/// <summary>On startup, cleans up any sidecar/images left by a prior update, then checks for updates
/// hourly. Self-disables when not running in Docker with the socket mounted.</summary>
